...
export const PLATFORM_EXPANSION = {
  ...
  journeyTitle: 'Our Expansion Journey',
  timeline: [
    { label: 'Live', clinic: 'Veterinary Clinics', note: 'Live', filled: true, tone: 'cyan' as const },
    { label: 'In Development', clinic: 'Dental Clinics', note: 'In Development', filled: true, tone: 'purple' as const },
    { label: 'Coming Next', clinic: 'General Practice', note: 'Coming Next', filled: false, tone: 'blue' as const },
    { label: 'Future', clinic: 'Specialty Clinics', note: 'Future', filled: false, tone: 'orange' as const },
  ],
  trustBar: [
...
export const CLINIC_TYPES = [
  {
    ...
    tone: 'cyan' as const,
    description:
      'Everything a veterinary practice needs to run smarter and deliver better care.',
    extendedDescription:
