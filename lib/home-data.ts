...
export const SOLUTION_SECTION = {
  ...
  rows: [
    ...
    },
    {
      ...
      features: [
        { icon: FlaskConical, title: 'Automated workflow', description: 'From sample to report without manual steps.' },
        { icon: ShieldCheck, title: 'Smart validations', description: 'Catch errors before they reach the chart.' },
        { icon: BarChart3, title: 'Real-time insights', description: 'Trends and analytics at a glance.' },
        { icon: Bell, title: 'Instant alerts', description: 'Critical results flagged immediately.' },
      ],
      stats: [
    ...
    },
    {
      ...
      features: [
        { icon: Package, title: 'Real-time tracking', description: 'Know exactly what you have, everywhere.' },
        { icon: Bell, title: 'Smart reorder alerts', description: 'Never run out of critical supplies.' },
        { icon: BarChart3, title: 'Usage insights', description: 'See what moves and what sits.' },
        { icon: Share2, title: 'Easy transfers', description: 'Move stock between locations instantly.' },
      ],
      stats: [
    ...
    },
    {
      ...
      tabLabel: 'Billing',
      moduleBadge: 'BILLING',
      title: 'Capture every charge.',
      titleAccent: 'Zero revenue leaks.',
      description: 'Turn visits into invoices automatically — no duplicate entry, no missed charges.',
      features: [
        { icon: Receipt, title: 'One-click invoicing', description: 'Generate invoices from completed visits.' },
        { icon: CreditCard, title: 'Payment tracking', description: 'Track payments and outstanding balances.' },
        { icon: BarChart3, title: 'Revenue insights', description: 'See trends and collection rates.' },
        { icon: ShieldCheck, title: 'Audit-ready records', description: 'Every charge logged and traceable.' },
      ],
      stats: [
        { icon: DollarSign, value: '$42k', label: 'Revenue This Month', tone: 'purple' as const },
        { icon: Receipt, value: '186', label: 'Invoices Sent', tone: 'blue' as const },
        { icon: CheckCircle2, value: '94%', label: 'Collection Rate', tone: 'green' as const },
        { icon: Clock, value: '2.1 days', label: 'Avg Payment Time', tone: 'orange' as const },
      ],
      visual: 'billing' as const,
      tone: 'blue' as const,
    },
    ...
    },
    {
      ...
      titleAccent: 'Keep patients on track.',
      description: 'Automated reminders and task assignment so no patient falls through the cracks.',
      features: [
        { icon: Smartphone, title: 'Multi-channel reminders', description: 'SMS, WhatsApp, and email in one flow.' },
        { icon: UserCheck, title: 'Task assignment', description: 'Assign follow-ups to the right team member.' },
        { icon: Calendar, title: 'Smart scheduling', description: 'Auto-suggest follow-up appointment slots.' },
        { icon: TrendingUp, title: 'Better retention', description: 'Track completion and patient return rates.' },
      ],
      stats: [
        { icon: Bell, value: '64', label: 'Reminders Sent', tone: 'purple' as const },
        { icon: MessageSquare, value: '38', label: 'SMS / WhatsApp', tone: 'blue' as const },
        { icon: Mail, value: '26', label: 'Email', tone: 'orange' as const },
        { icon: CheckCircle2, value: '87%', label: 'Completion Rate', tone: 'green' as const },
      ],
      visual: 'followup' as const,
      tone: 'orange' as const,
    },
